...
This can be found on the microsoft store, with `winget`, or can be installed with an offline script found on it's anywhere page [here](/docs/get-started/wsl).
...
Grab a USB stick! Use a flasher program to create an installer from the image. [Moonshot](https://github.com/fyralabs/moonshot) is an easy cross-platform choice.
